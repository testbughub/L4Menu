      ...
      case $MOSEL in
        ...
        2)
          ...
          if [[ $ANSWER -lt 1 ]]; then
            ...
            if sudo mount -t cifs -o user=$UNAME,credentials=/home/pi/.smbcredentials,uid=1000,iocharset=utf8 //$SERVERIP/ $ANSWER ;
            then
    ...
    3)
      ...
      case $SSSEL in
        1)
          ...
          then
            if sudo mount -t cifs -o user=$UNAME,credentials=/home/pi/.smbcredentials,uid=1000,iocharset=utf8 //$SERVERIP/roms $MOUNTPATH ;
            then
        ...
        2)
          ...
          then
            sudo mount -t cifs -o user=$UNAME,credentials=/home/pi/.smbcredentials,uid=1000,iocharset=utf8 //$SERVERIP/roms $MOUNTPATH
            if sudo mount -a ;
            then
    ...
    5)
      ...
      case $SKSEL in
        1)
          ...
          then
            if sudo mount -t cifs -o user=$UNAME,credentials=/home/pi/.smbcredentials,uid=1000,iocharset=utf8 //$SERVERIP/.skyscraper $MOUNTPATH ;
            then
        ...
        2)
          ...
          then
            if sudo mount -t cifs -o user=$UNAME,credentials=/home/pi/.smbcredentials,uid=1000,iocharset=utf8,iocharset=utf8 //$SERVERIP/.skyscraper $MOUNTPATH ;
            then
